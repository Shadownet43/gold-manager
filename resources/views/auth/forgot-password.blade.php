...
<head>
    ...
    <title>Lupa Password - WoW Gold RMT Tracker</title>
...
<body>
    <div class="container" style="max-width: 400px;">
        <div class="text-center mb-4">
            <i class="fas fa-key text-gold" style="font-size: 3rem;"></i>
            <h4 class="text-white mt-2">Lupa Password</h4>
            <p class="text-secondary small">Masukkan email untuk menerima link reset</p>
        </div>
        <div class="card shadow">
            <div class="card-header py-3"><i class="fas fa-envelope me-2"></i>Reset Password</div>
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" class="btn btn-warning w-100 fw-bold">Kirim Link Reset Password</button>
                </form>
